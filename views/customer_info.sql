...
if object_id('CustomerInfo','v') is not null
...
(
	...
	where t.EmailTypeId=3
)
select p.PersonId,p.Title,[Full Name],Gender,Age,[Full Address],[Phone Number],[Phone Type],[Email Address],[Email Type]
		from Person1 p
